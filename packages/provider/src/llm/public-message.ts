...
const DEFAULT_PUBLIC = "Something went wrong. Please try again in a moment.";

const MAP: Partial<Record<LLMErrorCode, string>> = {
  UNAUTHORIZED: "You do not have permission to use this service. Contact an administrator.",
  ...
  CONTENT_FILTER: "Your request did not pass safety checks. Revise it and try again.",
